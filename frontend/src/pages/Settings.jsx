        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="font-heading text-lg">AI Auto-Reply</CardTitle>
                <CardDescription>Configure AI-powered automatic message replies</CardDescription>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                platform.openai.com/api-keys <ExternalLink className="w-3 h-3 inline" />
              </a>
            </p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="openai_model">AI Model</Label>
            <Select 
              value={settings.openai_model} 
              onValueChange={(value) => setSettings({ ...settings, openai_model: value })}
            >
              <SelectTrigger data-testid="openai-model-select" className="w-full">
            ...
            <p className="text-xs text-muted-foreground">
              GPT-4o-mini: ~$0.15/1M tokens • GPT-4o: ~$5/1M tokens
            </p>
          </div>

          <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
            <p className="text-sm text-amber-500 font-medium mb-2">Coming Soon</p>
            <p className="text-xs text-muted-foreground">
              AI Auto-Reply is being developed. Configure your API key now to be ready when it launches.
              Features will include: per-contact conversation history, custom reply rules, and business context.
            </p>
          </div>
