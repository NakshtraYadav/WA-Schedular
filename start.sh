...
#  v2.7.0 - Fixed Python virtual environment support
# ============================================================================
...
case "${1:-start}" in
    ...
    *)
        echo ""
        echo -e "${BOLD}WA Scheduler v2.7.0${NC}"
        echo ""
        ...
        echo "  restart (r)       Full restart"
        echo "  restart-frontend  Restart frontend only (rf)"
        echo "  restart-backend   Restart backend only (rb)"
        echo "  update (u)        Pull latest from GitHub"
        echo "  status (s)        Check service status"
        echo "  logs [service]    View logs (backend/frontend/whatsapp)"
        echo "  diagnose (d)      Debug startup issues"
        echo ""
        echo "Examples:"
